...
자기소개입니다. 자기소개입니다.</textarea
  ...
  `},$=()=>{let l=new r().isLogin(),o=f()==="hash"?window.location.hash.slice(1):location.pathname;return o="front_5th_chapter1-1"+o,o==="/"?p():o==="/profile"?l?L():b():o==="/login"?l?p():b():E()},j=document.getElementById("root"),m=()=>{j.innerHTML=$()},v=document.getElementById("root");m();window.addEventListener("popstate",()=>m());window.addEventListener("hashchange",()=>m());v.addEventListener("submit",t=>w(t));v.addEventListener("click",t=>y(t));
